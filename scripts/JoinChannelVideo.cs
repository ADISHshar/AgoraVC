...
#region -- Button Events ---
        ...
        public void JoinChannel()
        {
            ...
            Log.UpdateLog("Joined Channel: " + _channelName);
        }
        ...
        public void StartPublish()
        {
            ...
            Log.UpdateLog("StartPublish - UpdateChannelMediaOptions: " + nRet);
        }
        ...
        public void StopPublish()
        {
            ...
            var nRet = RtcEngine.UpdateChannelMediaOptions(options);
            Log.UpdateLog("UpdateChannelMediaOptions: " + nRet);
        }
...
#region -- Video Render UI Logic ---
        ...
        internal static void MakeVideoView(uint uid, string channelId = "",Transform parent = null)
        {
            ...
            var videoSurface = MakeImageSurface(uid.ToString(), parent);
        ...
        private static VideoSurface MakeImageSurface(string goName, Transform parent)
        {
            ...
            var canvas = GameObject.Find("Video");
            if (canvas != null)
            {
        ...
        internal static void DestroyVideoView(uint uid)
        {
            ...
            {
        Debug.LogWarning($"Attempted to destroy GameObject with UID {uid}, but it is either null or inactive.");
            }
        }
...
#region -- Agora Event ---
    ...
    internal class UserEventHandler : IRtcEngineEventHandler
    {
        ...
        public override void OnJoinChannelSuccess(RtcConnection connection, int elapsed)
        {
            ...
            _videoSample.Log.UpdateLog("OnJoinChannelSuccess");
        }
        ...
        public override void OnUserJoined(RtcConnection connection, uint uid, int elapsed)
        {
            ...
            JoinChannelVideo.MakeVideoView(uid, _videoSample.GetChannelName(), _videoSample.videoPanel.transform);
            _videoSample.RtcEngine.MuteRemoteAudioStream(uid, false);
            _videoSample.Log.UpdateLog("Subscribed to remote audio stream for uid: " + uid);
        }
